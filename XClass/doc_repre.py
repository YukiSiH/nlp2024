...
def main():
    ...
    for t in range(1, T):
        ...
        for cls in range(len(class_names)):
            ...
            # 增加，新的类表示下，原有的词汇不能作为类表示了，导致集合改变，此时停止
    ...
    document_representations = [
        weight_sentence(model, vocab, _tokenization_info, class_representations,  layer)
    ...
    with open(os.path.join(data_folder, f"document_repr.pk"), "wb") as f:
        pk.dump({
